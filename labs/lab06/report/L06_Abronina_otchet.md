...
![Создание директории](image/1){ #fig:001 width=70% }
...
![Запуск исполняемого файла](image/5){ #fig:005 width=70% }

Изменяю в тексте программы символы "6" и "4" на цифры 6 и 4 (рис. [-@fig:006]). 

![Редактирование файла](image/6){ #fig:006 width=70% }
...
![Запуск исполняемого файла](image/7){ #fig:007 width=70% }
...
![Запуск исполняемого файла](image/10){ #fig:010 width=70% }

Заменяю в тексте программы в файле lab6-2.asm символы "6" и "4" на числа 6 и 4 (рис. [-@fig:011]).

![Редактирование файла](image/11){ #fig:011 width=70% }
...
![Запуск исполняемого файла](image/12){ #fig:012 width=70% }

Заменяю в тексте программы функцию iprintLF на iprint (рис. [-@fig:013]).

![Редактирование файла](image/13){ #fig:013 width=70% }
...
![Запуск исполняемого файла](image/22){ #fig:022 width=70% }
...
![Создание файла](image/23){ #fig:023 width=70% }

Открываю созданный файл для редактирования, ввожу в него текст программы для вычисления значения выражения 3*(x+10)-20 (рис. [-@fig:024]). Это выражение было под вариантом 18.

![Написание программы](image/24){ #fig:024 width=70% }

Создаю и запускаю исполняемый файл (рис. [-@fig:025]). При вводе значения 1, вывод - 13.

![Запуск исполняемого файла](image/25){ #fig:025 width=70% }
...
![Запуск исполняемого файла](image/26){ #fig:026 width=70% }
